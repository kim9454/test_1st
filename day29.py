...
# password 인자 사용st.header('text input 실습 1')
...
img = Image.open('./output/naver_image/baby monster/1.png')
st.image(img, width=300, caption='Image Naver')
...
with st.sidebar:
    ...
    side_option = st.multiselect(
        ...
        options=['Asa', 'Chiquita', 'Rora', 'Pharita', 'Ruka', 'Rami'],
        placeholder='select baby monster!!'
    )
